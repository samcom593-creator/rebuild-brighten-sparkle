...
Live counts this commit: **233 routes**, **333 page files**, **242 edge functions**,
...
| Recruiting | /dashboard/applicants, /dashboard/recruiting | admin/mgr/va | Pipeline+Queue | CHROME-ONLY |
| Interviews | /dashboard/interviews → Headhunter app | admin/mgr/va | external | UNPROVEN (separate repo) |
