...
const accountAuthTruthMigration = read("supabase/migrations/20260825122500_accounts_auth_truth.sql");
...
const requirements = [
  ...
  [accountAuthTruthMigration, "from auth.users u", "account totals require a real auth identity"],
  [read("src/pages/DashboardAccounts.tsx"), '"staff_existing_auth_user_ids"', "accounts intersect role/agent rows with auth truth"],
