  ...
  return (
    <>
      ...
      >
        ...
        {/* Header */}
        <div className="px-5 py-4 border-b border-border/30 bg-white dark:bg-card">
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-3">
              <div className="h-10 w-10 rounded-md bg-white dark:bg-card flex items-center justify-center shadow-sm shadow-primary/10">
            ...
            <AnimatePresence mode="popLayout">
              {totalALP > 0 && (
                <motion.div
                  ...
                  className="px-4 py-2 bg-white dark:bg-card border border-primary/30 rounded-md font-bold text-primary shadow-sm"
                >
