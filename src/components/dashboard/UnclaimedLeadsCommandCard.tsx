      ...
      <div className="relative space-y-2">
          ...
          {rows.map(row => {
            ...
            return (
              <motion.div
                ...
                className="flex items-center gap-3 rounded-xl border border-zinc-800/80 bg-zinc-900/60 p-3 hover:border-amber-400/40 hover:bg-zinc-900/80 transition-colors"
              >
        ...
        {counts.total > PREVIEW_ROW_LIMIT && (
          <button
            ...
            className="w-full mt-1.5 inline-flex items-center justify-center gap-1.5 rounded-lg border border-zinc-800/80 bg-zinc-900/40 py-2 text-xs font-semibold text-muted-foreground hover:text-foreground hover:border-amber-400/30 transition-colors"
          >
            {expanded ? (
