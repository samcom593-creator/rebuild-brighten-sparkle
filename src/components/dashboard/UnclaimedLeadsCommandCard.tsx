      ...
      <div className="relative space-y-2">
        ...
        {counts.total > PREVIEW_ROW_LIMIT && (
          <button
            ...
            className="w-full mt-1.5 inline-flex items-center justify-center gap-1.5 rounded-lg border border-zinc-800/80 bg-white dark:bg-zinc-900/40 py-2 text-xs font-semibold text-muted-foreground hover:text-foreground hover:border-amber-400/30 transition-colors"
          >
            {expanded ? (
