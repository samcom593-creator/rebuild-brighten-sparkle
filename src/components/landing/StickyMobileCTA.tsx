  ...
  return (
    <div className="fixed bottom-0 inset-x-0 z-40 md:hidden p-3 bg-white dark:bg-black/90 backdrop-blur-xl border-t border-primary/30 shadow-[0_-10px_40px_rgba(0,0,0,0.5)]">
      <Link
        ...
        className="flex items-center justify-center gap-2 py-3.5 rounded-md bg-white dark:bg-slate-900 text-primary-foreground font-bold font-display text-base shadow-[0_5px_25px_hsl(168_80%_50%/0.5)] active:scale-95 transition-transform"
      >
