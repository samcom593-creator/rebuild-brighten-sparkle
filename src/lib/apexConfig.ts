...
// ─── Scheduling Links ─────────────────────────────────────────────────────────
// One canonical owner for applicant scheduling. Personnel-specific placeholders
// are deliberately excluded so a departed team member cannot remain in routing.
