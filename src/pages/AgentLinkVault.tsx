...
function OverviewPanel() {
  ...
  const cards: Array<{ label: string; value: string; icon: any; gradient: string; iconColor: string }> = [
    ...
    { label: "Clients mirrored", value: data.clients.toLocaleString(), icon: Users,
      gradient: "from-info/15 via-info/5 to-transparent border-info/30",
      iconColor: "bg-info/15 text-info ring-blue-500/30" },
  ...
  return (
    <div className="space-y-4">
      ...
      <div className="grid grid-cols-2 md:grid-cols-4 gap-3">
        {cards.map((c) => (
          <Card key={c.label} className={`rounded-md overflow-hidden  border ${c.gradient}`}>
