...
export default function ScheduleCall() {
  ...
  if (hasLicense !== null) {
    const calendlyUrl = hasLicense ? LICENSED_CALENDLY : UNLICENSED_CALENDLY;
    return (
        ...
        <div className="max-w-xl mx-auto">
          <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.5 }}>
            <GlassCard className="p-8 text-center">
              ...
              <p className="text-xs text-muted-foreground mt-6">Either way, we're excited to chat with you about opportunities at Apex Financial!</p>
            </GlassCard>
          </motion.div>
