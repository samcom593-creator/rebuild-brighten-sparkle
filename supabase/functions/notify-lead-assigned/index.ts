        ...
        <div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto; word-break: break-word;">
          ...
          <div style="background: #f9fafb; padding: 30px; border: 1px solid #e5e7eb; border-top: none; border-radius: 0 0 10px 10px;">
            ...
            <div style="text-align: center; margin-top: 25px;">
              <a href="https://rebuild-brighten-sparkle.lovable.app/dashboard/applicants?lead=${applicationId}" style="display: inline-block; background: linear-gradient(135deg, #3b82f6 0%, #2563eb 100%); color: white; text-decoration: none; padding: 14px 28px; border-radius: 8px; font-weight: 600; font-size: 16px; margin-bottom: 15px; max-width:100%; box-sizing:border-box;">
                📞 View Lead & Call Now →
              </a>
