...
serve(async (req: Request) => {
  ...
  try {
    ...
    const { purchaserName, purchaserEmail, packageName, price, managerId } = body;

    console.log("Processing lead purchase notification:", {
      purchaserName, purchaserEmail, packageName, price,
    });
          ...
          html: `
            <div style="font-family: system-ui, sans-serif; max-width: 600px; margin: 0 auto;">
              ...
              <div style="background: #1f2937; padding: 24px; border-radius: 0 0 12px 12px;">
                <p style="color: #9ca3af; margin: 0 0 16px;">A team member has purchased leads via Stripe:</p>
                <div style="background: #374151; padding: 16px; border-radius: 8px; margin-bottom: 16px;">
                  ...
                  <p style="color: white; margin: 0 0 8px;"><strong>Payment:</strong> Stripe</p>
                  <p style="color: white; margin: 0;"><strong>Time:</strong> ${timestamp} CST</p>
                </div>
              </div>
              <p style="color: #6b7280; font-size: 11px; text-align: center; margin-top: 16px;">Powered by Apex Financial</p>
            </div>
          `,
        });
      }
          ...
          emailsToSend.push({
            ...
            html: `
              <div style="font-family: system-ui, sans-serif; max-width: 600px; margin: 0 auto;">
                ...
                <div style="background: #1f2937; padding: 24px; border-radius: 0 0 12px 12px;">
                  <p style="color: #9ca3af; margin: 0 0 16px;">Hey ${managerProfile.full_name || "Manager"},</p>
                  <p style="color: #9ca3af; margin: 0 0 16px;">One of your team members just purchased leads:</p>
                  <div style="background: #374151; padding: 16px; border-radius: 8px; margin-bottom: 16px;">
                  ...
                  <p style="color: #9ca3af; margin: 0;">— Sam</p>
                </div>
                <p style="color: #6b7280; font-size: 11px; text-align: center; margin-top: 16px;">Powered by Apex Financial</p>
              </div>
            `,
    ...
    emailsToSend.push({
      to: purchaserEmail,
      subject: `✅ Lead Purchase Confirmed: ${packageName}`,
      html: `
        <div style="font-family: system-ui, sans-serif; max-width: 600px; margin: 0 auto;">
          ...
          <div style="background: #1f2937; padding: 24px; border-radius: 0 0 12px 12px;">
            <p style="color: #9ca3af; margin: 0 0 16px;">Hey ${purchaserName},</p>
            <p style="color: #9ca3af; margin: 0 0 16px;">Thank you for investing in your pipeline! Here's your purchase summary:</p>
            <div style="background: #374151; padding: 16px; border-radius: 8px; margin-bottom: 16px;">
              <p style="color: white; margin: 0 0 8px;"><strong>Package:</strong> ${packageName}</p>
              <p style="color: white; margin: 0;"><strong>Amount:</strong> $${price}/week</p>
            </div>
            <p style="color: #9ca3af; margin: 0 0 16px;">Your leads will be delivered shortly. Get ready to close! 💪</p>
            <p style="color: #9ca3af; margin: 0 0 8px;">— Sam</p>
            <p style="color: #9ca3af; margin: 0; font-size: 12px; font-style: italic;">
              PS: The best closers follow up within 5 minutes of receiving their leads. Be that agent. 🔥
            </p>
          </div>
          <p style="color: #6b7280; font-size: 11px; text-align: center; margin-top: 16px;">Powered by Apex Financial</p>
        </div>
