          ...
          <table width="100%" cellpadding="0" cellspacing="0" style="background-color: #0a0a0f; padding: 40px 20px;">
            <tr><td align="center">
              <table width="600" cellpadding="0" cellspacing="0" style="background: linear-gradient(135deg, #1a1a2e 0%, #16213e 100%); border-radius: 16px; overflow: hidden; border: 1px solid rgba(0, 204, 153, 0.2);">
                ...
                <tr><td style="padding: 0 40px 30px; text-align: center;"><a href="${LICENSED_CALENDLY}" style="display: inline-block; background: linear-gradient(135deg, #00cc99 0%, #00a37a 100%); color: #000; text-decoration: none; padding: 16px 40px; border-radius: 8px; font-weight: 600; font-size: 16px;">Schedule Your Call →</a></td></tr>
          ...
          <table width="100%" cellpadding="0" cellspacing="0" style="background-color: #0a0a0f; padding: 40px 20px;">
            <tr><td align="center">
              <table width="600" cellpadding="0" cellspacing="0" style="background: linear-gradient(135deg, #1a1a2e 0%, #16213e 100%); border-radius: 16px; overflow: hidden; border: 1px solid rgba(0, 204, 153, 0.2);">
                ...
                <tr><td style="padding: 0 40px 30px; text-align: center;"><a href="${UNLICENSED_CALENDLY}" style="display: inline-block; background: linear-gradient(135deg, #00cc99 0%, #00a37a 100%); color: #000; text-decoration: none; padding: 16px 40px; border-radius: 8px; font-weight: 600; font-size: 16px;">Book a Licensing Help Call →</a></td></tr>
