          ...
          <table width="100%" cellpadding="0" cellspacing="0" style="background-color: #0a0a0f; padding: 40px 20px;">
            <tr><td align="center">
              <table width="100%" cellpadding="0" cellspacing="0" style="max-width:600px;background: linear-gradient(135deg, #1a1a2e 0%, #16213e 100%); border-radius: 16px; overflow: hidden; border: 1px solid rgba(0, 204, 153, 0.2);">
                ...
                <tr><td style="padding: 0 40px 30px; text-align: center;"><table role="presentation" cellspacing="0" cellpadding="0" style="margin:0 auto;"><tr><td bgcolor="#00cc99" style="border-radius:8px;"><a href="${LICENSED_CALENDLY}" style="display:inline-block;color:#000;text-decoration:none;padding:16px 32px;font-weight:600;font-size:16px;">Schedule Your Call →</a></td></tr></table></td></tr>
